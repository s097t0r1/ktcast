...
abstract class BaseDependencyHolder3<A1 : BaseFeatureAPI, A2 : BaseFeatureAPI, A3 : BaseFeatureAPI, D : BaseFeatureDependencies>(
    private val a1: A1,
    private val a2: A2,
    private val a3: A3,
) : BaseDependencyHolder<D>() {

    abstract val block: (A1, A2, A3, BaseDependencyHolder<D>) -> D

    val dependecies: D get() = block(a1, a2, a3, this)

    companion object {
        fun <D : BaseFeatureDependencies, A1 : BaseFeatureAPI, A2 : BaseFeatureAPI, A3 : BaseFeatureAPI> create(
            a1: A1,
            a2: A2,
            a3: A3,
            block: (A1, A2, A3, BaseDependencyHolder<D>) -> D
        ): D = object : BaseDependencyHolder3<A1, A2, A3, D>(
            a1 = a1,
            a2 = a2,
            a3 = a3
        ) {
            override val block: (A1, A2, A3, BaseDependencyHolder<D>) -> D = block
        }.dependecies
    }
}
